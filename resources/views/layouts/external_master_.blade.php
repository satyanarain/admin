   ...
   <aside class="main-sidebar">
     <section class="sidebar">
           <ul class="sidebar-menu">
                  ...
                  <li style="display:none;" @if($segments_var[0]=='depots') class="treeview active" @else class="treeview" @endif>
                        <a href="#">
                                ...
                                <div class="box box-default">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="col-md-7 col-sm-12 required">
                                                {{ Form::password('password_confirmation', array('class' => 'col-md-6 form-control','required' => 'required')) }}
                                            </div>
                                        </div> 
                                        <div class="form-group">
