...
<div class="form-group ">
 ...
 @if($donations->image_name!='')
<div class="form-group">
@if($donations->image_name!='')
{!! Form::label('image_name', Lang::get('Existing Image'), ['class' => 'col-md-3 control-label']) !!}
  <div class="col-md-7 col-sm-12">
{{Html::image('images/donation/thumbnail/'.$donations->image_name, 'a picture', array('width' => '100','height'=>'100'))}}
</div>
@else
{!! Form::label('image_name', Lang::get('Existing Image'), ['class' => 'col-md-3 control-label']) !!}
  <div class="col-md-7 col-sm-12">
...
<input type="checkbox" onclick='checkedValue()' id='donation' <?php if($donations->donation_list=='1'){ ?>checked="checked"<?php } ?>>&nbsp;Donations&nbsp;
    <?php } else { ?>
<input type="checkbox" onclick='checkedValue()' id='donation' <?php if($donations->donation_list=='1'){ ?>checked="checked"<?php } ?> checked="checked">&nbsp;Donations&nbsp;
    <?php } ?>

        <input type="checkbox" <?php if($donations->purchase_list=='1'){ ?>checked="checked" <?php } ?>  id='purchase' onclick='checkedValue_pur()'>&nbsp;Purchase&nbsp;
